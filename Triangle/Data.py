...
def timeshift(data, shifts, order=31):
    """
    Another implementation for lagrange interpolation (by Jean-Baptiste Bayle, Refs: PhysRevD.107.083019, LISAInstrument), which turns out to be the fastest one.
    The results have been validated by comparing with the original lagrange interpolation.
    Args:
        data: input array
